...
class UpdateProfileForm(forms.ModelForm):
    ...
    address = forms.CharField(widget=forms.TextInput({"address": 'form-control', "placeholder": "Address"}))

    class Meta:
        model = User
        fields = ('username', 'password', 'first_name', 'last_name', 'image', 'email', 'address', 'phone_number')